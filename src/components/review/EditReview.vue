    ...
    <div id="overlay"> 
        <div class="modal-container">
          <div class="modal-header">
            <slot name="header">
              <h1 id = 'reviewTitle'>Edit Review</h1>
          ...
          <div class="modal-body">
            <table id = "review">
              ...
              <tr class = "rows">
                ...
                <td class="spin">
                <b-form-spinbutton id="quality" v-model="quality" min="1" max="5" value=form.rating inline></b-form-spinbutton>
                </td>
              </tr>
              <tr class = "rows">
              <td class="one">Relevance of Content: </td>
                <td class="spin">
                <b-form-spinbutton id="relevance" v-model="relevance" min="1" max="5" value=form.learning inline></b-form-spinbutton>
                </td>
              </tr>
              <tr class = "rows">
